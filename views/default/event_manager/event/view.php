...
$event_details .= '<tr><td><label>' . elgg_echo('event_manager:edit:form:start_day') . ':</label></td><td>' . date("d/m/y", $event->start_day) . '</td></tr>';
...
$body .= elgg_view('beterwerken/share', $vars);
