...
if($user = elgg_get_logged_in_user_entity()){
    ...
    if($add_link){
        $content .= "<div>" . elgg_view("output/url", array("class"=>"purple", "text" => elgg_echo("event_manager:menu:new_event"), "href" => $add_link)) . "</div>";
    }
}

$content .= "<a href='" . elgg_get_site_url() . "events' class='purple'>Bekijk alle evenementen</a>";
